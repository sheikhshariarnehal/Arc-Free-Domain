    ...
    >
      ...
      <div className="grid grid-cols-2 gap-3 mt-4">
        <button
          ...
          className="group relative py-2.5 rounded-lg text-xs sm:text-sm font-semibold flex items-center justify-center gap-2 text-white cursor-pointer disabled:opacity-50 transition-all bg-white/8 hover:bg-white/14 border border-white/20 hover:border-white/30 active:scale-[0.98]"
