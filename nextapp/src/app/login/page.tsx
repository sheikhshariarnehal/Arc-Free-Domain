    ...
    >
      ...
      <div className="grid grid-cols-2 gap-3 mt-4">
        <button
          ...
          className="skeuo-button skeuo-button-rect w-full py-2.5 text-xs sm:text-sm font-semibold flex items-center justify-center gap-2 text-white border-none cursor-pointer disabled:opacity-50"
        >
