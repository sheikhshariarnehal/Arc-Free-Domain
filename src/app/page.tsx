        ...
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              ...
              <Card key={i} className="group p-5 flex flex-col gap-2.5 border border-white/[0.08] bg-[#0c0c0e]/80 hover:bg-[#121215] hover:border-white/15 hover:-translate-y-0.5 transition-all duration-200">
                <CardContent className="p-0 flex flex-col gap-2.5">
                  <div
                    className="size-8 rounded-lg bg-white/[0.06] border border-white/[0.08] flex items-center justify-center text-zinc-300 group-hover:border-white/20 group-hover:text-white transition-all duration-200"
        ...
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6">
            {[
              ...
              <Card key={i} className="group text-center p-5 sm:p-6 border border-white/[0.08] bg-[#0c0c0e]/80 hover:bg-[#121215] hover:border-white/15 hover:-translate-y-0.5 transition-all duration-200">
                <CardContent className="p-0 flex flex-col items-center">
                  <div className="flex size-7 items-center justify-center rounded-full bg-white/[0.06] border border-white/10 text-zinc-300 group-hover:text-white group-hover:border-white/20 font-mono text-xs font-semibold mb-3 group-hover:scale-105 transition-all duration-200">
                    {item.step}
                  </div>
